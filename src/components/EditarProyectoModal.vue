  ...
  export default {
    ...
    methods: {
      async submitForm() {
        ...
        try {
          // Formata os dados como um objeto JSON
          const payload = {
            id: this.form.id,
            ...
            fechaEstimadaInicio: this.formatToIso(this.form.fechaEstimadaInicio),
            fechaEstimadaFin: this.formatToIso(this.form.fechaEstimadaFin),
            fechaRealInicio: this.form.fechaRealInicio ? this.formatToIso(this.form.fechaRealInicio) : null,
            fechaRealFin: this.form.fechaRealFin ? this.formatToIso(this.form.fechaRealFin) : null,
          };
  
          await axios.put(`/api/proyecto/${this.form.id}`, payload, {
            headers: {
              'Content-Type': 'application/json',
            },
          });
  
          // Emite um evento para notificar o componente pai que o projeto foi editado
